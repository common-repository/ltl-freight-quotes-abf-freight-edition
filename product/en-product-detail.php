 ...
 * Class EnAbfFreightProductDetail
 * @package EnAbfFreightProductDetail
 */
if (!class_exists('EnAbfFreightProductDetail')) {
    ...
    class EnAbfFreightProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnAbfFreightProductDetail constructor.
         */
        public function __construct()
        {
            add_filter('en_app_common_plan_status', [$this, 'en_abf_freight_plan_status'], 10, 1);
         ...
         * @return array
         */
        public function en_abf_freight_plan_status($plan_status)
        {
            $en_plugin_name = 'LTL Freight Quotes - ABF Freight Edition';
            ...
            $plan_status['hazardous_material']['abf_freight'][] = 'abf_freight';
            ...
            $nesting_material = apply_filters("abf_quotes_quotes_plans_suscription_and_features", 'nested_material');
            if (is_array($nesting_material)) {
                $plan_required = '1';
                $nested_material_status = $en_plugin_name . ': Upgrade to Advanced Plan to enable.';
            }

            $plan_status['nesting']['abf_freight'][] = 'abf_freight';
        ...
        public function en_product_fields_arr()
        {
            $en_product_fields = [
                ...
                [
                    'type' => 'input_field',
                    'id' => '_eniture_product_nmfc_number',
                    'class' => '_eniture_product_nmfc_number short',
                    'label' => __( 'NMFC', 'woocommerce' ),
                    'placeholder' => 'e.g 100 or 123-497'
                ],
                [
                    'type' => 'input_field',
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("abf_quotes_plans_notification_link", [2, 3]);
