jQuery(document).ready(function () {
    ...
    // Origin terminal address
    // Terminal phone number
    jQuery("#en-phone-number, #en_wd_origin_address, #en_wd_origin_zip, #en_wd_origin_city, #en_wd_origin_state, #en_wd_origin_country, #instore-pickup-address, #instore-pickup-desc,  #local-delivery-address, #local-delivery-desc, #local-delivery-fee,   #en_wd_dropship_markup").focus(function (e) {
        jQuery("#add_warehouses #" + this.id).css({'border-color': '#ddd'});
    });

    // Origin terminal address
    // Terminal phone number
    jQuery("#en-phone-number, #en_wd_dropship_nickname, #en_wd_dropship_address, #en_wd_dropship_zip, #en_wd_dropship_city, #en_wd_dropship_state, #en_wd_dropship_country, #instore-pickup-address, #instore-pickup-desc, #local-delivery-address, #local-delivery-desc, #local-delivery-fee, #en_wd_dropship_markup ").focus(function (e) {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_warehouse_list_data">' + data.origin_city + '</td><td class="en_wd_warehouse_list_data">' + data.origin_state + '</td><td class="en_wd_warehouse_list_data">' + data.origin_zip + '</td><td class="en_wd_warehouse_list_data">' + data.origin_country + '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_dropship_list_data">' + data.nickname + '</td><td class="en_wd_dropship_list_data">' + data.origin_city + '</td><td class="en_wd_dropship_list_data">' + data.origin_state + '</td><td class="en_wd_dropship_list_data">' + data.origin_zip + '</td><td class="en_wd_dropship_list_data">' + data.origin_country + '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
