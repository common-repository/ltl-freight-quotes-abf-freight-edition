...
<script type="text/javascript">
    ...
    function change_warehouse_zip() {
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
            ...
            <div class="content" style="overflow-y: scroll; height: 500px;">
                ...
                <form method="post" id="add_warehouses">
                    ...
                    if (is_plugin_active('preferred-origin/preferred-origin.php')) {
                        ...
                        echo $preferred_provider_lfq;
                        echo $preferred_provider_sqp;
                    }
                    ?>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" title="Zip" maxlength="7" onchange="change_warehouse_zip()" value=""
                               name="en_wd_origin_zip" placeholder="30214" id="en_wd_origin_zip">
                        <span class="en_wd_err"></span>
                    </div>
                    <div class="en_wd_add_warehouse_input city_input">
                        <label for="en_wd_origin_city">City</label>
                        <input type="text" class="alphaonly" title="City" value="" name="en_wd_origin_city"
                               placeholder="Fayetteville" id="en_wd_origin_city">
                        <span class="en_wd_err"></span>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="alphaonly" maxlength="2" title="State" value=""
                               name="en_wd_origin_state" placeholder="GA" id="en_wd_origin_state">
                        <span class="en_wd_err"></span>
                    </div>
                    <div class="en_wd_add_warehouse_input">
                        <label for="en_wd_origin_country">Country</label>
                        <input type="text" class="alphaonly" maxlength="2" title="Country" name="en_wd_origin_country"
                               value="" placeholder="US" id="en_wd_origin_country">
                    ...
                    <div class="heading">
                        ...
                        <a href="#">
                            <h2 class="local-delivery-heading pakage_notify"><?php echo $package_required; ?></h2>
                        </a>
                    </div>
                    ...
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_warehouse" value="Save" class="save_warehouse_form"
                               onclick="return en_wd_save_warehouse();">
                    </div>
                </form>
            </div>
        </div>
