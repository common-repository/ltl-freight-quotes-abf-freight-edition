...
<script type="text/javascript">
    ...
    function change_dropship_zip() {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
                ...
                <form method="post" id="add_dropships">
                    ...
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_dropship" value="Save" class="save_warehouse_form"
                               onclick="return en_wd_save_dropship();">
                    </div>
                </form>
            </div>
        </div>
