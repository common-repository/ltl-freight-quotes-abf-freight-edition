    ...
    class EnWooWdAddonsAjaxReqIncludes
    {
        ...
        function get_address_api_ajax()
        {
            if (isset($_POST['origin_zip'])) {
                ...
                $accessLevel = 'address';
                $Get_sm_distance = new Get_abf_freight_distance();
                $resp_json = $Get_sm_distance->abf_freight_address($zipCode, $accessLevel);
        ...
        function save_warehouse_ajax()
        {
            ...
            if (is_plugin_active('preferred-origin/preferred-origin.php')) {
                $input_data_arr = apply_filters('en_pref_field', $input_data_arr, $inputData);
            }
