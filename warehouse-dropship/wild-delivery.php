...
if (!function_exists("en_woo_wd_admin_script_style")) {
    function en_woo_wd_admin_script_style()
    {
        ...
        wp_enqueue_script('en_woo_wd_script', plugin_dir_url(__FILE__) . '/wild/assets/js/warehouse_section.js', array(), '1.0.4');
                        ...
                        <td class="en_wd_warehouse_list_data">
                            <a href="javascript(0)"
                               onclick="return en_wd_edit_warehouse(<?php echo (isset($list->id)) ? esc_attr($list->id) : ''; ?>);"><img
                                        src="<?php echo plugins_url(); ?>/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/edit.png"
                                        title="Edit"></a>
                            <a href="javascript(0)"
                               onclick="return en_wd_delete_current_warehouse(<?php echo (isset($list->id)) ? esc_attr($list->id) : ''; ?>);"><img
                                        src="<?php echo plugins_url(); ?>/ltl-freight-quotes-abf-freight-edition/warehouse-dropship/wild/assets/images/delete.png"
                                        title="Delete"></a>
                        </td>
                    </tr>
                    <?php
