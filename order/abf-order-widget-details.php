...
if (!class_exists("en_abf_view_Order_Widget_Details")) {
    class en_abf_view_Order_Widget_Details
    {
...
//            if(count($order_data) == 1) {
            if ($shipment == 'multiple') {
                ...
                foreach ($order_data as $key => $value) {
                    ...
                    (isset($value->key) && $value->key == "quote_id") ? $this->quote_id = $value->value : "";
        ...
        public function show_order_widget_detail()
        {
            ...
            echo strlen($this->quote_id) > 0 ? '<li>Quote ID: ' . $this->quote_id . '</li>' : '';
    ...
    new en_abf_view_Order_Widget_Details();
}
